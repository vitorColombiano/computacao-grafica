...
function circleVertices(cx, cy, radius, angulo = 0) {
    const vertices = [];
    const numSides = 50;
    ...
    for (let i = 0; i <= numSides; i++) {
        const angle = i * 2 * Math.PI / numSides + angulo;
 ...
 * @param {WebGLProgram} program - Programa shader compilado
 */
WebGLLib.createCircle = function(gl, data, colors, program, angulo=0){
    ...
    const points = circleVertices(cx, cy, radius, angulo);
